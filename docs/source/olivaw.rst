Managing projects with Asimov
=============================

Asimov has a command line interface which is designed to make working with your project easier.

Creating projects
-----------------

You can use asimov to produce a new project, and set up the required directory structure automatically.
