...
Getting started with asimov - Gravitational-wave analysis
=========================================================

.. note:: 

   This guide will get you started with a gravitational-wave analysis using the latest version of asimov.
   The analysis you'll set up with this guide will be a fairly standard parameter estimation analysis.
   If you need more control over the settings you want to use for your analyses then you should continue to read the user guide for examples of more complex analyses.
...
.. steps::
   ...
   .. step:: Download analysis defaults
   ...
   .. step:: Building the pipeline and submitting to the cluster
...
Chances are if you're looking at asimov you'll want to do something a little more complicated — the next section points you to the relevant guides.
