...
Note that this approach to the database is a departure from what I set up initially for the database backed logger, and I think it would be better to use a document database going forward.

Implementation
--------------

Initially the implementation is designed to use TinyDB but that's just because I want something I can work with easily on a laptop. 
